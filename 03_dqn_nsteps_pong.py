...
from lib.buffers import Common_NSteps_ExperienceBuffer
...
def calc_loss(batch, net, tgt_net, device="cpu"):
    ...
    td_target = rewards_v + GAMMA**args.steps * q_targert
...
if __name__ == "__main__":
    ...
    parser.add_argument("--env", default=DEFAULT_ENV_NAME,
                        help="Name of the environment, default=" +
                             DEFAULT_ENV_NAME)
    parser.add_argument("--steps", default=DEFAULT_N_STEPS,
                        help="Steps of bootstrap, default=" +
                             DEFAULT_N_STEPS)
    ...
    buffer = Common_NSteps_ExperienceBuffer(REPLAY_SIZE, \
                                        args.steps, GAMMA)
    ...
    while True:
        ...
        if reward is not None:
            ...
            np.savetxt(dir + "dqn_mean_reward_episode_{}.csv".format(start_datetime), np.array(mean_rewards), delimiter=",")
            np.savetxt(dir + "dqn_reward_{}.csv".format(start_datetime), np.array(total_rewards), delimiter=",")
